...
_You've now added a fully functioning workflow to your repository! :smile:_  No smile

The shell script in the workflow will run whenever a new pull request is opened.  Really.  I mean really.
